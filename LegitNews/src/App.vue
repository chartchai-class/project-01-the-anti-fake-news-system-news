...
<template>
  <div id="app" class="flex flex-col min-h-screen">
    <!-- 1st Nav -->
    <header class="bg-white border-b border-gray-300 px-[50px] py-3 flex items-center justify-between relative">
    ...
    <!-- 2nd Nav -->
    <nav class="hidden md:flex bg-white border-b border-gray-300 py-3 mx-auto w-full max-w-[1200px] px-6 items-center justify-between">
    ...
    <div v-if="isOpen" class="absolute top-[70px] left-0 w-full bg-white shadow-lg border-t border-gray-300 z-50 md:hidden">
