...
const stats = ref([
    { title: 'Total News', value: '116', change: '+8%', iconBgClass: 'bg-amber-500', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><line x1="10" y1="9" x2="8" y2="9"></line></svg>', to: { path: '/', query: { type: 'all' } } },
    { title: 'Verified News', value: '100', change: '+15%', iconBgClass: 'bg-green-500', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>', to: { path: '/', query: { type: 'real' } } },
    { title: 'Fake News', value: '16', change: '-5%', iconBgClass: 'bg-red-500', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>', to: { path: '/', query: { type: 'fake' } } },
    { title: 'Total Users', value: '1,234', change: '+12%', iconBgClass: 'bg-blue-500', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M22 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>', to: '/' },
    { title: 'Members', value: '780', change: '+5%', iconBgClass: 'bg-purple-500', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"></rect><path d="M9 3v18"></path><path d="M3 9h18"></path><path d="M3 15h18"></path></svg>', to: '/' },
    { title: 'Readers', value: '454', change: '+3%', iconBgClass: 'bg-cyan-500', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"></path><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"></path></svg>', to: '/' },
]);
                ...
                <div class="lg:col-span-3 bg-white p-6 rounded-xl shadow-lg border border-gray-100">
                    ...
                    <ul class="space-y-4">
                        <li v-for="(contributor, index) in topContributors" :key="index" class="flex items-center justify-between border-b border-gray-100 pb-4 last:border-b-0 last:pb-0">
                            <div class="flex items-center">
                                <div :class="[contributor.avatarBgClass, 'w-10 h-10 flex items-center justify-center rounded-full text-white font-bold text-sm mr-4 flex-shrink-0']">
